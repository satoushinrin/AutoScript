...
:: Set watermark path
set "watermark=C:\Tools\preset\image\h_watermark.png"
...
for %%a in (%*) do (
    ...
    %ffmpeg_path% -i "%%~a" -i "%watermark%" -filter_complex "[1:v]scale=!width!:!height![wm];[0:v][wm]overlay=0:0,scale=960:540" -q:v 1 "!dir!Converted\!rename!.jpg"
)
exit /b
